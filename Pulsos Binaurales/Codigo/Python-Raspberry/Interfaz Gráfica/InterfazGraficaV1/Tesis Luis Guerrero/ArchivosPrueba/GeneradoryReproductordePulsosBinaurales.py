...
def binauralgenerator (basefreq,samplerate,binfreq,duration,samplecounter):
    ...
    str1 = str(basefreq)
    str2 = str(binfreq)
    filename = "BinauralFrecuenciaCentral"+str1+"FrecuenciaPulso"+str2+".wav"
    wavfile.write(filename,sr,y)
    return filename, y
    song = AudioSegment.from_wav("/home/pi/Desktop/Tesis Luis Guerrero/BinauralFrecuenciaCentral"+str1+"FrecuenciaPulso"+str2+".wav")
    song.export("/home/pi/Desktop/Tesis Luis Guerrero/SISEPUDO"+stringbase+".ogg", format="ogg")
