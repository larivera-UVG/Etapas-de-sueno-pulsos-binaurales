...
if exist('C:\Users\kokal\OneDrive\Documents\Primer Semetre 2020\Diseno e innovacion\Datos Pyshio\EEGLAB\eeglab2019_1\eeglab') ~=2
...
% Save the current directory and move to the test directory
init_dir = pwd;
cd(test_dir);
...
[edf, header] = mexSLOAD(edf_file_name.name);
